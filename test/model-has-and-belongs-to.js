...
describe("Model.prototype.has() & Model.prototype.belongsTo()", function () {
    it("should create model associations as expected", function (done) {
        ...
        co(function* () {
            ...
            assert.equal(article.sql, 'select * from (select * from "articles2" where "user_id" = ?) where rownum <= 1');
            ...
            assert.equal(_user.sql, 'select * from (select * from "users2" where "id" = ?) where rownum <= 1');
            ...
            assert.equal(userTag.sql, 'select * from (select * from "tags2" where "taggable_id" = ? and "type" = ?) where rownum <= 1');
            ...
            assert.equal(user2.sql, 'select * from (select * from "users2" where "id" = ?) where rownum <= 1');
